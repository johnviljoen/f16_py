...
class Py_lookup():
    ...
    """
    This class parses the .dat files in the same way as the C code, allowing for direct use with
    other interpolation schemes, such as polynomial, or neural network learning of the tables etc...
    """
